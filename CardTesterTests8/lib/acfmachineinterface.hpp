...
#define ACF_MACHINE_INTERFACE_VERSION 2
...
/**
 * CardRun. Perform all chip activities for a station, the function will be called for every position where a card is placed.
 ...
 * iCardPosition input: the number on which reader the card is positioned.
